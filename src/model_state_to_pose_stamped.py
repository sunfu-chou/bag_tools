...
class ModelStateToPoseStamped:
    def __init__(self):
        ...
        self.pose_topic_suffix = rospy.get_param("~pose_topic_suffix", "/pose_stamped")
        self.publish_rate = rospy.get_param("~publish_rate", 20)

        self.pose_publisher = rospy.Publisher(self.model_name + self.pose_topic_suffix, PoseStamped, queue_size=10)
